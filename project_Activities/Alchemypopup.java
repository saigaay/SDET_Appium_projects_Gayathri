...
//	  driver.findElementById("com.android.chrome:id/search_box_text").click();
	  ...
	  driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"Popups\").instance(0))"));
